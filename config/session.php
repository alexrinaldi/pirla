...
return [
    ...
    */
    ...
    | the user's session token. This will determine how the session cookie
    | behaves when an exception is thrown or the user logs out.
    |
    */

    'cookie' => [
        'name' => env('SESSION_COOKIE_NAME', 'PHPSESSID'),
        'lifetime' => env('SESSION_COOKIE_LIFETIME'),
